...
public class select extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="select roomcode,name,type,howmany,howmuch from roomajax order by roomcode";
		try {
			...
			while(rs.next()) {
				...
				strReturn+=rs.getInt("roomcode")+","+rs.getString("name")+","+rs.getInt("type")+","+
									rs.getInt("howmany")+","+rs.getInt("howmuch");
			}
		} catch (Exception e) {
